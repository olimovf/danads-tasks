...
describe("Discount Calculation", () => {
	...
	test("Non-member customer with $150 cost should have 5% discount", () => {
		expect(calculateDiscount(150, false)).toBe(5);
	});

	test("Member customer with $80 cost should have 10% discount", () => {
		expect(calculateDiscount(80, true)).toBe(10);
	});

	test("Member customer with exactly $100 cost should have 10% discount", () => {
